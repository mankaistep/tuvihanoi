...
export const PhuTinh = {
    ...
    TUONG_QUAN: { key: "TUONG_QUAN", name: "Tướng Quân", type: "cat" },
    TAU_THU:    { key: "TAU_THU", name: "Tấu Thư", type: "cat" },
    PHI_LIEM:   { key: "PHI_LIEM", name: "Phi Liêm", type: "sat" },
    HI_THANH:   { key: "HI_THANH", name: "Hỷ Thần", type: "cat" },
    ...
    PHUC_DUC_TT: { key: "PHUC_DUC_TT", name: "Phúc Đức", type: "cat" },
    ...
    DAO_HOA:   { key: "DAO_HOA", name: "Đào Hoa", type: "binh" }, 
    HONG_LOAN: { key: "HONG_LOAN", name: "Hồng Loan", type: "binh" },
    HOA_CAI:   { key: "HOA_CAI", name: "Hoa Cái", type: "binh" },
