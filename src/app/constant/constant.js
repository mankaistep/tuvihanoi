...
export const PhuTinh = {
    // Vòng Lộc Tồn
    LOC_TON:    { key: "LOC_TON", name: "Lộc Tồn", type: "cat" },
    BAC_SI:     { key: "BAC_SI", name: "Bác Sĩ", type: "cat" },
    LUC_SI:     { key: "LUC_SI", name: "Lực Sĩ", type: "cat" },
    THANH_LONG: { key: "THANH_LONG", name: "Thanh Long", type: "cat" },
    TIEU_HAO:   { key: "TIEU_HAO", name: "Tiểu Hao", type: "sat" },
    TUONG_QUAN: { key: "TUONG_QUAN", name: "Tướng Quân", type: "sat" },
    TAU_THU:    { key: "TAU_THU", name: "Tấu Thư", type: "cat" },
    PHI_LIEM:   { key: "PHI_LIEM", name: "Phi Liêm", type: "sat" },
    HI_THAN:   { key: "HI_THAN", name: "Hỷ Thần", type: "cat" },
    BENH_PHU:   { key: "BENH_PHU", name: "Bệnh Phù", type: "sat" },
    DAI_HAO:    { key: "DAI_HAO", name: "Đại Hao", type: "sat" },
    PHUC_BINH:  { key: "PHUC_BINH", name: "Phục Binh", type: "sat" },
    QUAN_PHU:   { key: "QUAN_PHU", name: "Quan Phủ", type: "sat" },
  
    // Vòng Thái Tuế
    THAI_TUE:    { key: "THAI_TUE", name: "Thái Tuế", type: "sat" },
    THIEU_DUONG: { key: "THIEU_DUONG", name: "Thiếu Dương", type: "cat" },
    TANG_MON:    { key: "TANG_MON", name: "Tang Môn", type: "sat" },
    THIEU_AM:    { key: "THIEU_AM", name: "Thiếu Âm", type: "cat" },
    QUAN_PHU_TT: { key: "QUAN_PHU_TT", name: "Quan Phù", type: "sat" },
    TU_PHU:      { key: "TU_PHU", name: "Tử Phù", type: "sat" },
    TUE_PHA:     { key: "TUE_PHA", name: "Tuế Phá", type: "sat" },
    LONG_DUC:    { key: "LONG_DUC", name: "Long Đức", type: "cat" },
    BACH_HO:     { key: "BACH_HO", name: "Bạch Hổ", type: "sat" },
    PHUC_DUC: { key: "PHUC_DUC", name: "Phúc Đức", type: "cat" },
    DIEU_KHACH:  { key: "DIEU_KHACH", name: "Điếu Khách", type: "sat" },
    TRUC_PHU:    { key: "TRUC_PHU", name: "Trực Phù", type: "sat" },
  
    // Tứ Hóa
    HOA_LOC:   { key: "HOA_LOC", name: "Hóa Lộc", type: "cat" },
    HOA_QUYEN: { key: "HOA_QUYEN", name: "Hóa Quyền", type: "cat" },
    HOA_KHOA:  { key: "HOA_KHOA", name: "Hóa Khoa", type: "cat" },
    HOA_KY:    { key: "HOA_KY", name: "Hóa Kỵ", type: "sat" },
  
    // Tuần Không
    TUAN_KHONG: { key: "TUAN_KHONG", name: "Tuần Không", type: "sat" },
    TRIET_KHONG:{ key: "TRIET_KHONG", name: "Triệt Không", type: "sat" },
  
    // Các sao theo Thiên Can
    DA_LA:      { key: "DA_LA", name: "Đà La", type: "sat" },
    KINH_DUONG: { key: "KINH_DUONG", name: "Kình Dương", type: "sat" },
    LUU_HA:     { key: "LUU_HA", name: "Lưu Hà", type: "sat" },
    QUOC_AN:    { key: "QUOC_AN", name: "Quốc Ấn", type: "cat" },
    DUONG_PHU:  { key: "DUONG_PHU", name: "Đường Phù", type: "cat" },
    VAN_TINH:   { key: "VAN_TINH", name: "Văn Tinh", type: "cat" },
    THIEN_KHOI: { key: "THIEN_KHOI", name: "Thiên Khôi", type: "cat" },
    THIEN_VIET: { key: "THIEN_VIET", name: "Thiên Việt", type: "cat" },
    THIEN_QUAN: { key: "THIEN_QUAN", name: "Thiên Quan", type: "cat" },
    THIEN_PHUC: { key: "THIEN_PHUC", name: "Thiên Phúc", type: "cat" },
    THIEN_TRU:  { key: "THIEN_TRU", name: "Thiên Trù", type: "cat" },
  
    // Sao theo Địa Chi
    PHUONG_CAC:{ key: "PHUONG_CAC", name: "Phượng Các", type: "cat" },
    GIAI_THAN: { key: "GIAI_THAN", name: "Giải Thần", type: "cat" },
    LONG_TRI:  { key: "LONG_TRI", name: "Long Trì", type: "cat" },
    NGUYET_DUC:{ key: "NGUYET_DUC", name: "Nguyệt Đức", type: "cat" },
    THIEN_DUC: { key: "THIEN_DUC", name: "Thiên Đức", type: "cat" },
    THIEN_HY:  { key: "THIEN_HY", name: "Thiên Hỷ", type: "cat" },
    THIEN_MA:  { key: "THIEN_MA", name: "Thiên Mã", type: "cat" },
    THIEN_KHOC:{ key: "THIEN_KHOC", name: "Thiên Khốc", type: "sat" },
    THIEN_HU:  { key: "THIEN_HU", name: "Thiên Hư", type: "sat" },
    DAO_HOA:   { key: "DAO_HOA", name: "Đào Hoa", type: "cat" }, 
    HONG_LOAN: { key: "HONG_LOAN", name: "Hồng Loan", type: "cat" },
    HOA_CAI:   { key: "HOA_CAI", name: "Hoa Cái", type: "cat" },
    KIEP_SAT:  { key: "KIEP_SAT", name: "Kiếp Sát", type: "sat" },
    PHA_TOAI:  { key: "PHA_TOAI", name: "Phá Toái", type: "sat" },
    CO_THAN:   { key: "CO_THAN", name: "Cô Thần", type: "sat" },
    QUA_TU:    { key: "QUA_TU", name: "Quả Tú", type: "sat" },
  
    // Tháng sinh
    TA_PHU:    { key: "TA_PHU", name: "Tả Phù", type: "cat" },
    HUU_BAT:   { key: "HUU_BAT", name: "Hữu Bật", type: "cat" },
    THIEN_HINH:{ key: "THIEN_HINH", name: "Thiên Hình", type: "sat" },
    THIEN_RIEU:{ key: "THIEN_RIEU", name: "Thiên Riêu", type: "sat" },
    THIEN_Y:   { key: "THIEN_Y", name: "Thiên Y", type: "cat" },
    THIEN_GIAI:{ key: "THIEN_GIAI", name: "Thiên Giải", type: "cat" },
    DIA_GIAI:  { key: "DIA_GIAI", name: "Địa Giải", type: "cat" },
  
    // Giờ sinh
    VAN_XUONG: { key: "VAN_XUONG", name: "Văn Xương", type: "cat" },
    VAN_KHUC:  { key: "VAN_KHUC", name: "Văn Khúc", type: "cat" },
    DIA_KHONG: { key: "DIA_KHONG", name: "Địa Không", type: "sat" },
    DIA_KIEP:  { key: "DIA_KIEP", name: "Địa Kiếp", type: "sat" },
    THAI_PHU:  { key: "THAI_PHU", name: "Thai Phụ", type: "cat" },
    PHONG_CAO: { key: "PHONG_CAO", name: "Phong Cáo", type: "cat" },
    ...
    THIEN_THUONG: { key: "THIEN_THUONG", name: "Thiên Thương", type: "sat"}
